...
class AirlinesControllerTest < ActionController::TestCase
  ...
  test "should create airline" do
    assert_difference('Airline.count') do
      post :create, airline: { code: @airline.code, description: @airline.description, enabled: @airline.enabled, name: @airline.name }
    end
  ...
  test "should update airline" do
    put :update, id: @airline, airline: { code: @airline.code, description: @airline.description, enabled: @airline.enabled, name: @airline.name }
    assert_redirected_to airline_path(assigns(:airline))
  end
